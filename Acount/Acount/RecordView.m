...
{
    [self setFrame:CGRectMake(0, 0, width, 20)];
}

- (void)time
{
    _timeLab = [[UILabel alloc] initWithFrame:CGRectMake(20, 0, 50, 20)];
...
- (void)detail
{
    _detailLab = [[UILabel alloc] initWithFrame:CGRectMake(80, 0, CGRectGetWidth(self.frame)-150, 20)];
...
- (void)price
{
    _priceLab = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.frame)- 100, 0, 80, 20)];
